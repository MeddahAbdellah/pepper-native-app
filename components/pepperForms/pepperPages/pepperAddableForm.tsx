...
const PepperItemAddableForm = (carouselProps: { item: { prefix:string, typeForm: PepperFormType, 
  bottomImage:PepperImages,
  productCategory : string,

}, nextFormTrigger:()=>void, onDataSubmitted:(formData: any)=>void}):JSX.Element => {
    ...
    <>
      ...
      <ScrollView style={localStyles.addableFormContainer}>
        ...
        <View
          ...
          <PepperImage src={carouselProps.item.bottomImage} style={localStyles.bottomImage}/>
        </View>
        ...
        <View style={{ flexDirection:'row',paddingTop:3*space_unit }}>
          <TextInput
            ...
            placeholder={carouselProps.item.productCategory+" Name ..."}
        ...
        <View style={localStyles.inputHolder}>
          ...
          <TouchableOpacity onPress={() => {
            ...
            <View style={{
              ...
              <Text style={localStyles.newItemButton}>Add {carouselProps.item.productCategory}</Text>
            </View>
          </TouchableOpacity>
        </View>
